  ...
  return (
    <main className="min-h-screen bg-gray-50/50 flex flex-col">
      ...
      <div className="flex-1 max-w-7xl mx-auto px-[clamp(1rem,5vw,2rem)] w-full py-[clamp(1.5rem,5vw,3rem)]">
        ...
        <div className="bg-white rounded-2xl p-5 md:p-6 shadow-sm border border-accent mb-8 flex flex-col md:flex-row gap-6 items-start md:items-center no-flash">
