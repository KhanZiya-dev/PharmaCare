      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-10">
        ...
        <div className="bg-[#eff6ff] dark:bg-[#111111] border border-[#dbeafe] dark:border-[#222222] rounded-2xl p-8 text-center text-[#00236f] dark:text-[#ffffff]">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/medicines"
              className="inline-flex items-center justify-center gap-2 bg-primary dark:bg-[#ffffff] text-white dark:text-[#000000] px-6 py-3 rounded-full font-semibold hover:bg-primary/90 dark:hover:bg-gray-200 transition-colors shadow-sm"
            >
              Browse Medicines
            ...
            <Link
              href="/lab-tests"
              className="inline-flex items-center justify-center gap-2 bg-white dark:bg-[#ffffff]/10 border border-gray-200 dark:border-[#ffffff]/30 text-gray-700 dark:text-[#ffffff] px-6 py-3 rounded-full font-semibold hover:bg-gray-50 dark:hover:bg-[#ffffff]/20 transition-colors"
            >
              Browse Lab Tests
              <ArrowRight className="h-4 w-4" />
            </Link>
