      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-10">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-500 max-w-2xl">
            Compare prices for diagnostic packages and lab tests from trusted labs across India. Get the best deals on health checkups.
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="font-bold text-foreground text-lg mb-1">No lab tests found</h3>
